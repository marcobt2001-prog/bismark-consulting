...
const pairings = [
  { industry: 'Food Production & Distribution', operation: 'Supplier Qualification' },
  { industry: 'Enterprise Technology', operation: 'Incident Management & Resolution' },
  { industry: 'Industrial Technology', operation: 'Spare Parts Inventory & Fulfillment' },
  { industry: 'Healthcare', operation: 'Discharge Planning' },
  { industry: 'Financial Processing', operation: 'Account Maintenance & Corrections' },
];
      ...
      <section className="py-20 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-display text-4xl md:text-5xl mb-8">
              SEE WHAT WE SEE. START WITH A CONVERSATION.
            </h2>

            <p className="text-gray-300 leading-relaxed mb-8">
              The first step is a 30&ndash;45 minute call where we discuss your operational landscape, confirm mutual fit, and schedule your on-site Walkthrough. It&rsquo;s not a sales call. It&rsquo;s the same rigor in miniature, and it&rsquo;s the conversation every client we&rsquo;ve ever engaged started with.
            </p>
